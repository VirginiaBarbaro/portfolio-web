                ...
                <CardBody className="d-flex lh-lg">
                  ...
                  <div className="col-6 d-flex justify-content-center">
                    <ul className="list-inline">
                      ...
                      <li>
                        {" "}
                        <i className="bi bi-check-circle-fill me-2"></i>Material
                        UI
                      </li>
                    </ul>
                  </div>
                ...
                <CardBody className="d-flex lh-lg">
                  ...
                  <div className="col-6 d-flex justify-content-center">
                    <ul className="list-inline">
                      <li>
                        {" "}
                        <i className="bi bi-check-circle-fill me-2"></i>MongoDB
                      </li>
                      <li>
                        {" "}
                        <i className="bi bi-check-circle-fill me-2"></i>
                      ...
                      <li>
                        {" "}
                        <i className="bi bi-check-circle-fill me-2"></i>Restful
                        API
                      </li>
                      <li>
                        {" "}
