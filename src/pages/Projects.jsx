        ...
        <div className="container todo-project">
          <div className="row">
            ...
            <div className="col-6 right-col">
              ...
              <div className="p-2">
                <p>
                  TO-DO is a web application that enables users to create lists,
                  add items, mark them as completed, or delete them.
                </p>
                <p>
                  <strong>Tech used:</strong> React, Redux, Bootstrap, Chakra UI
                </p>
              </div>
            ...
            <div className="col-6 right-col">
              ...
              <div className="p-2">
                <p>
                  ...
                  feature has been implemented, allowing users to filter movies
                  by rating or search by title.
                </p>
                <p>
                  <strong>Tech used:</strong> Ext. API, React, Redux, Bootstrap
                </p>
              </div>
              <div className="mt-4 mb-4 text-center d-flex justify-content-center">
